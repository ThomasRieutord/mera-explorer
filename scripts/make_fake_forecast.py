...
parser.add_argument("--forecaster", help="The type of fake forecast (persistence, gradientincrement; see neural_lam.forecasters)", default="persistence")
...
if args.forecaster == "persistence":
    ...
    raise ValueError(f"Unknown fake forecast option {args.forecaster}. See neural_lam.forecasters to have vaild options")
